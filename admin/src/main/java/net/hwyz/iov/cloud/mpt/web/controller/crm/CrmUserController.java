package net.hwyz.iov.cloud.mpt.web.controller.crm;
...
import net.hwyz.iov.cloud.mpt.system.service.ISysPostService;
...
{
    private String prefix = "crm/user";
    ...
    @RequiresPermissions("crm:user:view")
    @GetMapping()
    public String user()
    {
        return prefix + "/user";
    ...
    @RequiresPermissions("crm:user:export")
    @PostMapping("/export")
    @ResponseBody
    ...
    @RequiresPermissions("crm:user:import")
     ...
     * 新增保存用户
     */
    @RequiresPermissions("crm:user:add")
     ...
     * 修改用户
     */
    @RequiresPermissions("crm:user:edit")
    ...
    @RequiresPermissions("crm:user:remove")
